...
export default function Footer() {
  return (
    <footer className="bg-[#171136]">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[100px] py-14 grid grid-cols-1 lg:grid-cols-[280px_1fr_1fr_1fr_220px] gap-10">
        <div>
      ...
      <div className="border-t border-[#2A2159]">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-[100px] py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
